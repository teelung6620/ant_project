...
class WhitebloodPage extends StatefulWidget {
  const WhitebloodPage({Key? key}) : super(key: key);

  @override
  State<WhitebloodPage> createState() => _WhitebloodState();
}

class _WhitebloodState extends State<WhitebloodPage> {
