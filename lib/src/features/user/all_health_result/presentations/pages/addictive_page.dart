...
class AddictivePage extends StatefulWidget {
  const AddictivePage({Key? key}) : super(key: key);

  @override
  State<AddictivePage> createState() => _AddictiveState();
}
